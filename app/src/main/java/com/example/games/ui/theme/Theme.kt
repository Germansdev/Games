...
val LightGamesColorScheme = lightColorScheme(
    primary = Green40,
    onPrimary = Color.White,
    primaryContainer = Green90,
    onPrimaryContainer = Green10,
 ...
 */
@VisibleForTesting
val DarkGamesColorScheme = darkColorScheme(
    primary = Green80,
    onPrimary = Green20,
    primaryContainer = Green30,
    onPrimaryContainer = Green90,
...
/**
 * Light Games gradient colors
 */
val LightGamesGradientColors = GradientColors(container = DarkGreenGray95)

/**
 * Dark Games gradient colors
 */
val DarkGamesGradientColors = GradientColors(container = Color.Black)

/**
 * Light Games background theme
 */
val LightGamesBackgroundTheme = BackgroundTheme(color = DarkGreenGray95)

/**
 * Dark Games background theme
 */
val DarkGamesBackgroundTheme = BackgroundTheme(color = Color.Black)
...
val colorScheme = when {
    myTheme -> if (darkTheme) DarkGamesColorScheme else LightGamesColorScheme
...
//whith only this: top color with different color:
     ...
     *
     *
     26 09 with nia nothing of this sideEffects*/
    ...
    // Gradient colors
     ...
     val gradientColors = when {
        ...
        !disableDynamicTheming && supportsDynamicTheming() -> if (darkTheme) DarkGamesGradientColors else LightGamesGradientColors//28 09 only to see emptyGradientColors
        else -> if (darkTheme) DarkGamesGradientColors else LightGamesGradientColors// 28 09 only to see defaultGradientColors
        }
        // Background theme
